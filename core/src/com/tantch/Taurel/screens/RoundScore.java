...
public class RoundScore implements Screen {
	private Stage stage;
	private Table table;
	private Skin skin;
	private float score;

	public RoundScore(float score2) {
		score = score2;
	}
	...
	public void show() {
		...
		// setting header
		Label heading = new Label("Final Score", skin, "big");
		heading.setFontScale(2);
		Label heading2 = new Label("" + score, skin, "big");
